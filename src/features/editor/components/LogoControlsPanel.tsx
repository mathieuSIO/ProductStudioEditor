...
export function LogoControlsPanel({
  ...
  if (!controls) {
    return (
      <div className="rounded-[1.15rem] border border-stone-200 bg-stone-50/80 p-3">
        ...
        <div className="mt-3 rounded-[1rem] border border-dashed border-stone-300 bg-white/80 px-3 py-4 text-sm leading-5 text-stone-400">
  ...
  return (
    <div className="rounded-[1.15rem] border border-stone-200 bg-stone-50/80 p-3">
      ...
      <div className="mt-3 rounded-[1rem] border border-stone-200 bg-white/90 px-3 py-2.5">
